...
error_reporting(0);
class client_proposals_hired extends CI_Controller {
...
public function __construct()
	...
	public function index()
	{
		...
		if($myuser_id!="") {
			...
			$this->load->view('client_proposals_hired',$my_event);  
		}
		else {
			redirect('login');
		}
	...
	{    
		 if($_POST) 
			{	
				...
				$data['blogs'] = $this->invite_model->invited_details_of_talent($data['blogs']);
				...
				//print_r($data['blogs']);
				$this->load->view('client_proposals_hired_list_view',$data);
