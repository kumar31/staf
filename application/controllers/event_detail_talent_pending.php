...
error_reporting(0);
class event_detail_talent_pending extends CI_Controller {
...
public function __construct()
	...
	public function index()
	{
		...
		if($myuser_id!="") {
			...
			$my_event['pending'] = $this->invite_model->invited_details_of_talent_pending($my_event,$myuser_id); 
			$this->load->view('event_detail_talent_pending',$my_event);
		}
		else {
			redirect('login');
		}		
