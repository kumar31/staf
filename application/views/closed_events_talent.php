...
$(document).ready(function() {
	...
	$('#results').load("http://smaatapps.com/nector/website/index.php/closed_events_talent/getblogdata/<?php echo $myuser_id ?>", {'group_no':track_load}, function() {track_load++;}); //load first group
	...
	$(window).scroll(function() { //detect page scroll
		...
		if($(window).scrollTop() + $(window).height() == $(document).height())  //user scrolled to bottom of the page?
		{
			...
			if(track_load <= total_groups && loading==false) //there's more data to load
			{
				...
				$.post('http://smaatapps.com/nector/website/index.php/closed_events_talent/getblogdata/<?php echo $myuser_id ?>',{'group_no': track_load}, function(data){
          ...
          <div class="row">
            <div class="col-xs-9">
              <ul id="tabs" class="nav nav-pills" data-tabs="tabs">                
                <li class="active">
                  <a class="dashboard_tab bring-forward" href="#hired" data-toggle="tab">Worked events
                  </a>
                </li>			
              </ul>
              <div class="dashboard_tab_wrapper">
            ...
            <div class="tab-pane active" id="hired">
              <div class="w-section inverse blog-grid">
					...
					<?php 
						if($get_total_rows == 0) { ?>
							 <div class="col-md-12">
								<h4 class="text-center text-warning">You haven't worked any events yet</h4>
							 </div>
						<?php }
					?>
