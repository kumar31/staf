        ...
        <div class="col-sm-8 whiteBG invitebox topmargin30 profile">
          <div>
            ...
            <div class="prepend-top form-group">
              ...
              <input class="form-control" name="" id="inputEmail" type="text" maxlength="85" value="<?php echo $talent_profile[0]['email'] ?>">
            ...
            <div class="prepend-top form-group">
              ...
              <select class="col-xs-12 form-control form-group" id="emailfrequency" name="">
                <option value="30" <?php if(isset($talent_profile[0]['email_frequency']) && $talent_profile[0]['email_frequency'] == "30") echo 'selected="selected"';?>>30</option>
                
				<option value="20" <?php if(isset($talent_profile[0]['email_frequency']) && $talent_profile[0]['email_frequency'] == "20") echo 'selected="selected"';?>>20</option>
                  
                <option value="10" <?php if(isset($talent_profile[0]['email_frequency']) && $talent_profile[0]['email_frequency'] == "10") echo 'selected="selected"';?>>10</option>
                  
                <option value="Default" <?php if(isset($talent_profile[0]['email_frequency']) && $talent_profile[0]['email_frequency'] == "Default") echo 'selected="selected"';?>>Default</option>
              </select>
	 ...
	 <script>
		...
		function notification(){
			...
			var talent_id = <?php echo $talent_profile[0]['talent_id']; ?>; 
				...
				var url = 'http://smaatapps.com/nector/webservice/index.php/update_emailnotification_talent';
				
				$.ajax({
					'type' : 'POST',
					'url': url,
					'data': {'talent_id':talent_id,'email':email,'email_notification':email_notification,'email_frequency':email_frequency},
					//'dataType': 'json',
