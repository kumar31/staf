...
$(document).ready(function() {
	...
	$('#results').load("http://smaatapps.com/nector/website/index.php/invite_talent/getblogdata/<?php echo $myuser_id ?>", {'group_no':track_load}, function() {track_load++;}); //load first group
	...
	$(window).scroll(function() { //detect page scroll
		...
		if($(window).scrollTop() + $(window).height() == $(document).height())  //user scrolled to bottom of the page?
		{
			...
			if(track_load <= total_groups && loading==false) //there's more data to load
			{
				...
				$.post('http://smaatapps.com/nector/website/index.php/invite_talent/getblogdata/<?php echo $myuser_id ?>',{'group_no': track_load}, function(data){
            ...
            <div class="tab-pane active" id="red">
             <div class="w-section inverse blog-grid">					
					...
					<?php 
						if($get_total_rows == 0) { ?>
							 <div class="col-md-12">
								<h4 class="text-center">You haven’t created any events yet. Please create your first event now to invite talent</h4>
								 <p class="centerText">
