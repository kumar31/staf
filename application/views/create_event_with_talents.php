  ...
  <script>
				   ...
				   complete: function(){
					...
					success: function(data) {
						...
						if(message == "1") {
							...
							//window.location.assign("http://smaatapps.com/nector/website/index.php/client_dashboard/"+client_id );
						}
						else {
		...
		function invite_talent(event_id){
			...
			var client_id = <?php echo $client_id; ?>; 
				...
				var url = 'http://smaatapps.com/nector/webservice/index.php/invite_added_talents';
