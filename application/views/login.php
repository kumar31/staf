...
<!-- Modal -->
  ...
  function signin(){
		...
		var usertype = $("input[name='user']:checked").val();
			...
			var url = 'http://smaatapps.com/nector/webservice/index.php/login';
				...
				success: function(data) {
					...
					if(message == "1") {
						if(usertype == "1") {
							...
							/*session(id);*/
							window.location.assign("http://smaatapps.com/nector/website/index.php/client_dashboard/"+clientid );
						}
						if(usertype == "2") {
							var talentid = JSON.stringify(data['result']['talent_id']);
							var talentid = talentid.replace(/\"/g, "");
							window.location.assign("http://smaatapps.com/nector/website/index.php/talent_dashboard/"+talentid);
						}						
					}
					else {
  ...
  $("input:radio").change(function() {
	...
	function add(type){
		...
		var typeid = 1; 
			...
			var url = 'http://smaatapps.com/nector/webservice/index.php/type';
  ...
  function checktype() {
	  if (!$("input[name='user']:checked").val()) {
		  ...
		  window.location.assign("http://smaatapps.com/nector/website/index.php/fb");
		}
  }
  ...
  function signupchk() {
	  if (!$("input[name='user']:checked").val()) {
		...
		if ($("input[name='user']:checked").val() == "1") { 
		  window.location.assign("http://smaatapps.com/nector/website/index.php/client_registration");
		}
		if ($("input[name='user']:checked").val() == "2") { 
		  window.location.assign("http://smaatapps.com/nector/website/index.php/talent_registration");
		}
  }
