		 ...
		 <div class="form-group prepend-top">
		  ...
		  <div class="prepend-top clearfix">
			...
			<div class="form-group">
				...
				<div class="">
				  <label>
					<input type="checkbox" name="skills" value="personality,host" <?php if(isset($event_detail[0]['talent_requested_for'])) { if($event_detail[0]['talent_requested_for'] == "personality,host") { echo "checked";} }  ?>>
					Personality/Host
				  </label>
				</div>
			  </div>
  ...
  <script>
		...
		function register(){
			...
			if(typeof open_to_all === "undefined") {
				...
				var url = 'http://smaatapps.com/nector/webservice/index.php/update_event';
				...
				$.ajax({
				   ...
				   complete: function(){
					...
					success: function(data) {
						...
						if(message == "1") {
							var event_id = <?php echo $event_detail[0]['event_id']; ?>; 
							window.location.assign("http://smaatapps.com/nector/website/index.php/event_detail/"+event_id );
						}
						else {
