          ...
          <div class="row">
			...
			<div class="col-xs-12 col-sm-4"> 
			  ...
			  <hr>
				...
				if($uniform == "1") {
					$uniform = "http://smaatapps.com/nector/website/img/Black%20tie.png";
				}
				if($uniform == "2") {
					$uniform = "http://smaatapps.com/nector/website/img/White%20shirt%20black%20tie.png";
				}
				if($uniform == "3") {
					$uniform = "http://smaatapps.com/nector/website/img/custom%20outfit.png";
				}
			  ?>
			...
			<div class="col-xs-12 col-sm-4"> 
				<h3>Event Picture
				 ...
				 <hr>
				<img class="img-thumbnail" style="width: 340px; height: 200px;" src="<?php echo $event_detail[0]['event_pic']; ?>">
              ...
              <hr>
			   <div class="col-xs-6">
				  <div class="col-xs-3 col-sm-3">
                    <img style="width: 150px; height: 150px;" src="<?php echo $event_detail[0]['profile_url']; ?>" class="img-circle">
                  </div>
              </div>
