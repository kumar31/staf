		...
		<div class="col-md-4">
		 ...
		 <div class="form-group prepend-top">
		  ...
		  <div class="prepend-top form-group">
			...
			<img class="eimg img-thumbnail" style="width: 350px; height: 150px;" src="">
			<br>
			<br>
              ...
              <div class="col-xs-12 col-sm-12 gutter-bottom">
                ...
                <div class='input input-positioned'>
                  ...
                  <div id="addressdetails">
                    ...
                    <input type="hidden" id="lat" disabled=disabled> 
                    <!--<br/>
                    <label>Lng:      
                    </label> -->
                    <input type="hidden" id="lng" disabled=disabled> 
          ...
          <div class="form-group prepend-top">
            ...
            <select class="col-xs-12 form-control form-group" name="" id="waitersnum" >
              <option value="" selected="selected">Greater than 50
              </option>
              <option value="" selected="selected">40 - 50
              </option>
              <option value="" selected="selected">30 - 40
              </option>
              <option value="" selected="selected">10 - 20
              </option>
              <option value="" selected="selected">6 - 10
              </option>
              <option value="" selected="selected">1-5
              </option>
            </select>
          </div>
		  ...
		  <div class="prepend-top clearfix">
			...
			<div class="clearfix privacy-selector">
			  <div>
				<input value="1" name="uniformprovided" id="" class="pull-left" type="radio" checked>                   
  ...
  <script>
		...
		function register(){
			...
			if(typeof open_to_all === "undefined") {
				...
				var url = 'http://smaatapps.com/nector/webservice/index.php/create_event';
				
				$.ajax({
					'type' : 'POST',
					'url': url,
					'data': {'client_id':client_id,'email':email,'event_name':eventname,'event_contact':eventcontact,
					'start_datetime':start_datetime,'end_datetime':end_datetime,'location':location,'locality':locality,
	...
	/*$('#uniform_description').focus( function() {
	  $("input[name=uniform][value='3']").prop("checked",true);
	  //$("input[name=uniformprovided][value='0']").prop("checked",true);
	});*/

	/*$('#uniform_description').blur( function() {
	 $("input[name=uniform][value='3']").prop("checked",false);
	 //$("input[name=uniformprovided][value='1']").prop("checked",true);
	});*/
	</script>	
</body>
</html>
