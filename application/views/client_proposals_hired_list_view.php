		  ...
		  <!-- single Person -->
	         <div id="person" class="person">
              <div class="row persona">
				...
				<?php 
				  ...
				  ?>
                   <div class="checkbox checkbox-warning"> 
					<a role="button" class="btn btn-danger btn-lg largeHeight" data-toggle="modal" data-target="#myModal">&nbsp;&nbsp;&nbsp;Remove&nbsp;&nbsp;&nbsp;</a>						
                    </div>
				<?php } ?>
				...
				?>
				<div class="checkbox checkbox-warning"> 
					<a role="button" class="btn btn-danger btn-lg largeHeight" disabled>&nbsp;&nbsp;&nbsp;Remove&nbsp;&nbsp;&nbsp;</a>						
                    </div>
				<?php } ?>
                </div>
              </div>
				  ...
				  <div class="modal-content">
					...
					<div class="modal-body">
					 <!--<div class="form-group">
					  <label for="rejectreason">Remove Reason</label>
					...
					<input type="hidden" value="<?php echo $talent['talent_id']; ?>" id="reject<?php echo $talent['talent_id']; ?>">					  
					   ...
					   role="button" id="btn2" textbox_id2="#reject<?php echo $talent['talent_id']; ?>">Remove
					 </a>	
					</div>
...
<script>
  ...
  function rejectevent(textbox_val2){
		...
		var reason = $("#rejectreason").val();
			...
			var url = 'http://smaatapps.com/nector/webservice/index.php/reject_talent_by_client';
