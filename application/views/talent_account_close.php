	...
	<script>
		...
		function close(){
			var talent_id = <?php echo $talent_profile[0]['talent_id']; ?>; 
				...
				var url = 'http://smaatapps.com/nector/webservice/index.php/talent_account_close';
				...
				$.ajax({
					...
					success: function(data) {
						...
						if(message == "1") {								
							window.location.assign("http://smaatapps.com/nector/website/index.php/talent_logout");
						}
						else {
