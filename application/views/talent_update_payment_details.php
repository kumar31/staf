	...
	<script>
		...
		function cardupdate(){
			...
			var talent_id = <?php echo $talent_profile[0]['talent_id']; ?>;
				...
				var url = 'http://smaatapps.com/nector/stripe/create_bank_recipient.php';
				
				$.ajax({
					'type' : 'POST',
					'url': url,
					'data': {'fname':card_fname,'lname':card_lname,'account_number':account_number,'routing_number':routing_number,'email':email,'talent_id':talent_id},
					//'dataType': 'json',
