...
<div style="display: none;" class="se-pre-con"></div>
  ...
  <div class="container">
    <div class="row">
				  ...
				  <input type="hidden" value="<?php echo $event_detail[0]['event_id']; ?>" id="apply<?php echo $event_detail[0]['event_id']; ?>">
				   <?php 
					if($events == "0") { ?>
					   ...
					   role="button" id="btn1" textbox_id="#apply<?php echo $event_detail[0]['event_id']; ?>">Apply
					 </a>
					<?php } ?>
      ...
      <div class="col-sm-4 col-xs-12 topmargin listings-invitebar">
		...
		var event_id = textbox_val; 
			...
			$.ajax({
				...
				success: function(data) {
					...
					if(message == "1") {
							window.location.assign("http://smaatapps.com/nector/website/index.php/talent_dashboard/"+talent_id );
						}
				}
