...
$(document).ready(function() {
	...
	$('#results').load("http://smaatapps.com/nector/website/index.php/client_proposals_pending/getblogdata/<?php echo $event_detail[0]['event_id']; ?>", {'group_no':track_load}, function() {track_load++;}); //load first group
	...
	$(window).scroll(function() { //detect page scroll
		...
		if($(window).scrollTop() + $(window).height() == $(document).height())  //user scrolled to bottom of the page?
		{
			...
			if(track_load <= total_groups && loading==false) //there's more data to load
			{
				...
				$.post('http://smaatapps.com/nector/website/index.php/client_proposals_pending/getblogdata/<?php echo $event_detail[0]['event_id']; ?>',{'group_no': track_load}, function(data){
          ...
          <div class="row">
            <div class="col-xs-9">
              <ul id="tabs" class="nav nav-pills" data-tabs="tabs">
                <li class="active">
                  <a class="dashboard_tab bring-forward" href="#red" data-toggle="tab">Pending
                  </a>
                </li>
                <li>
