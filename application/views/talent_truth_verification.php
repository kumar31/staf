...
<body>
  ...
  function verify(){
		...
		var type = 2;
			...
			var url = 'http://smaatapps.com/nector/webservice/index.php/mobile_verify';
  ...
  function verifynum(){
		...
		var code = $("#code").val();
			...
			var url = 'http://smaatapps.com/nector/webservice/index.php/mobile_number_check';
  ...
  function verifyemail(){
		...
		var first_name = "<?php echo $talent_profile[0]['first_name']; ?>"; 
			...
			var url = 'http://smaatapps.com/nector/webservice/index.php/talent_email_verify';
