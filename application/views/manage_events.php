...
$(document).ready(function() {
	...
	$('#results').load("http://smaatapps.com/nector/website/index.php/manage_events/getblogdata/<?php echo $myuser_id ?>", {'group_no':track_load}, function() {track_load++;}); //load first group
	...
	$(window).scroll(function() { //detect page scroll
		...
		if($(window).scrollTop() + $(window).height() == $(document).height())  //user scrolled to bottom of the page?
		{
			...
			if(track_load <= total_groups && loading==false) //there's more data to load
			{
				...
				$.post('http://smaatapps.com/nector/website/index.php/manage_events/getblogdata/<?php echo $myuser_id ?>',{'group_no': track_load}, function(data){
