	...
	<script>
		...
		function close(){
			var client_id = <?php echo $client_profile[0]['client_id']; ?>; 
				...
				var url = 'http://smaatapps.com/nector/webservice/index.php/client_account_close';
				...
				$.ajax({
					...
					success: function(data) {
						...
						if(message == "1") {								
							window.location.assign("http://smaatapps.com/nector/website/index.php/client_logout");
						}
						else {
