...
$(document).ready(function() {
	...
	$('#results').load("http://smaatapps.com/nector/website/index.php/search_talent/getblogdata", {'group_no':track_load,'search':search,'special_skills':special,'hair_color':haircolor,'eye_color':eyecolor,'languages':language,'height_min':heightfrom,'height_max':heightto,'best_rating':sort,'gender':gender}, function() {track_load++;}); //load first group
	...
	$(window).scroll(function() { //detect page scroll
		...
		if($(window).scrollTop() + $(window).height() == $(document).height())  //user scrolled to bottom of the page?
		{
			...
			if(track_load <= total_groups && loading==false) //there's more data to load
			{
				...
				$.post('http://smaatapps.com/nector/website/index.php/search_talent/getblogdata',{'group_no': track_load,'search':search,'special_skills':special,'hair_color':haircolor,'eye_color':eyecolor,'languages':language,'height_min':heightfrom,'height_max':heightto,'best_rating':sort,'gender':gender}, function(data){
  ...
  <body>    
    <div class="container">
      <div class="row" style="margin-bottom: 200px; margin-top:20px;">
		...
		<a class="btn btn-danger btn-block" href="<?php echo site_url();?>/create_event_with_talents" role="button">Create event</a>
	  <hr>
          <section class=
