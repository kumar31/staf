			   ...
			   <?php 
				 $invitedid = $invited_details;
					...
					<a class=
					   ...
					   role="button" id="btn1" textbox_id="#apply<?php echo $talent_detail[0]['talent_id']; ?>">Invite
					 </a>
					 <?php } ?>
	...
	<script>
	  ...
	  function applytoevent(textbox_val){
			...
			var client_id = <?php echo $myuser_id; ?>; 
				...
				var url = 'http://smaatapps.com/nector/webservice/index.php/invite_talent';
				...
				$.ajax({
					...
					success: function(data) {
						...
						if(message == "1") {
								window.location.assign("http://smaatapps.com/nector/website/index.php/invite_talent_search" );
							}
