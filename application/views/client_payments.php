          ...
          <table class="table topmargin">
			...
			{ ?>
				<tbody>
				  <tr>
					<td>
					  <a target="_blank" href="http://smaatapps.com/nector/html2pdf_v4.03/examples/adv.php?event_id=<?php echo $val['client_payment_details_id']; ?>"><?php echo $val['transaction_id']; ?>
					  </a>					  
					</td>
            ...
            <table class="table">
              <tbody>
                ...
                <tr>
				  ...
				  ?>
                  <td class="bold">$<?php echo $paid_to_date; ?>
                  </td>
                </tr>
				<tr>
				  ...
				  ?>
                  <td class="bold">$<?php echo $refund_amount; ?>
                  </td>
                </tr>
              </tbody>
            </table>
